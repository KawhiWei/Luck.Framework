...
using Luck.Mongo.DbContexts;
using Microsoft.Extensions.DependencyInjection;
using Microsoft.Extensions.DependencyInjection.Extensions;
using MongoDB.Bson;
using MongoDB.Bson.Serialization.Conventions;

namespace Luck.Mongo.Extensions
{
    public static class MongoServiceExtensions
    {
        internal const string Pack = "mongo:pack";
        /// <summary>
        /// 添加Mongo上下文
        /// </summary>
        ...
        /// <returns></returns>
        public static IServiceCollection AddMongoDbContext<TContext>(this IServiceCollection serviceCollection, [CanBeNull] Action<MongoContextOptions> options)
            where TContext : MongoDbContextBase
        {

            MongoContextOptions options1 = new MongoContextOptions();
