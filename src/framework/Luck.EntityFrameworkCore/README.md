...
```bash
dotnet add package Luck.EntityFrameworkCore --version 2.0.9
```

项目支持 `net6.0`、`net7.0`、`net8.0`、`net9.0` 和 `net10.0`。包依赖 `Luck.AppModule`、`Luck.DDD.Domain`、`Luck.Framework`、`Microsoft.EntityFrameworkCore` 和 `EFCore.NamingConventions`；EF Core 及命名约定包会按目标框架选择版本。
